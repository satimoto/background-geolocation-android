    ...
    public static class NotificationFactory {
        ...
        public Notification getNotification(String title, String text, String largeIcon, String smallIcon, String color) {
            ...
            if (launchIntent != null) {
                ...
                int flags = Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ? PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_CANCEL_CURRENT : PendingIntent.FLAG_CANCEL_CURRENT;
